            ...
            <div className="max-w-md mx-auto px-4 pointer-events-auto">
                <nav className="bg-industrial text-white border-2 border-black shadow-industrial p-2 grid grid-cols-3 items-center rounded-lg">
                    ...
                    <button
                        ...
                        className="justify-self-center bg-industrial-yellow text-black p-5 rounded-full border-2 border-black shadow-none -mt-10 hover:-translate-y-11 transition-all active:translate-y-0 active:shadow-inner flex items-center justify-center cursor-pointer"
                    >
